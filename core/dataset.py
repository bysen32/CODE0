...
class CUB:
    def __init__(self, root, is_train=True, data_len=None):
        ...
        for line in img_txt_file:
            image_name_list.append(line[:-1].split(" ")[-1])
        ...
        train_file_list = [x for i, x in zip(train_test_list, image_name_list) if i]
        test_file_list = [x for i, x in zip(train_test_list, image_name_list) if not i]
